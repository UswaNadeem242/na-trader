...
export default function Banner() {
  return (
   <section
  className="relative min-h-[900px] lg:min-h-[1000px] overflow-hidden rounded-[20px] bg-cover bg-center bg-no-repeat"
...
>
      ...
      {/* Content */}
      <div className="relative z-10 flex min-h-[900px] items-center justify-center">
